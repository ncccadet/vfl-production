...
const styles = {
  ...
  subtitle: { color: 'rgba(255,255,255,0.6)', fontSize: '0.9rem', textAlign: 'center', marginTop: '0.5rem', marginBottom: '2rem' },
  label: { color: 'rgba(255,255,255,0.8)', fontSize: '0.85rem', marginBottom: '0.4rem', marginTop: '1rem' },
  input: {
